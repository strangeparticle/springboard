 ...
 * translate between [AiClientRequest] / [AiClientResponse] (provider-neutral) and the provider's
...
internal interface AiClient {
     ...
     * Throws [AiClientException] on transport / authentication / parse / provider errors.
     */
     ...
     * enters a key. Throws [AiClientException] if the key is invalid or the network is
     * unreachable.
     */
