...
import com.strangeparticle.springboard.app.domain.mutator.removeApp

internal class RemoveAppToolCallHandler : ToolCallHandler {
    override val providerToolId = "remove_app"
    override val description = "Remove an existing app."
    override val schema = requestSchema(RemoveAppToolCallHandlerRequest.serializer())

    suspend fun executeToolCallHandler(args: RemoveAppToolCallHandlerRequest, context: SpringboardToolCallExecutionContext): SpringboardToolCallHandlerResponse {
        ...
        return context.applyMutation(args.tab_id) { removeApp(springboard, args.id) }
    }
    ...
    override suspend fun executeToolCallHandler(toolCallId: String, argumentsAsJsonString: String, context: ToolCallExecutionContext): ToolCallHandlerResponse {
        val args = decodeToolCallHandlerRequest(argumentsAsJsonString, RemoveAppToolCallHandlerRequest.serializer())
