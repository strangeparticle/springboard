...
import com.strangeparticle.springboard.app.domain.mutator.reorderResources

internal class ReorderResourcesToolCallHandler : ToolCallHandler {
    override val providerToolId = "reorder_resources"
    override val description = "Replace the ordering of resources."
    override val schema = requestSchema(ReorderResourcesToolCallHandlerRequest.serializer())
    suspend fun executeToolCallHandler(args: ReorderResourcesToolCallHandlerRequest, context: SpringboardToolCallExecutionContext): SpringboardToolCallHandlerResponse {
        ...
        return context.applyMutation(args.tab_id) { reorderResources(springboard, args.ordered_ids) }
    }
    override suspend fun executeToolCallHandler(toolCallId: String, argumentsAsJsonString: String, context: ToolCallExecutionContext): ToolCallHandlerResponse {
        val args = decodeToolCallHandlerRequest(argumentsAsJsonString, ReorderResourcesToolCallHandlerRequest.serializer())
