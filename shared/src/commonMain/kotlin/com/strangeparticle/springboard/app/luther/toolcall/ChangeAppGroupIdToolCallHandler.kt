...
import com.strangeparticle.springboard.app.domain.mutator.changeAppGroupId
...
internal class ChangeAppGroupIdToolCallHandler : ToolCallHandler {
    override val providerToolId = "change_app_group_id"
    override val description = "Change the id of an existing app group and rewrite apps that reference that group id."
    override val schema = requestSchema(ChangeAppGroupIdToolCallHandlerRequest.serializer())

    suspend fun executeToolCallHandler(args: ChangeAppGroupIdToolCallHandlerRequest, context: SpringboardToolCallExecutionContext): SpringboardToolCallHandlerResponse {
        ...
        return context.applyMutation(args.tab_id) { changeAppGroupId(springboard, args.id, args.new_id) }
    }
    ...
    override suspend fun executeToolCallHandler(toolCallId: String, argumentsAsJsonString: String, context: ToolCallExecutionContext): ToolCallHandlerResponse {
        val args = decodeToolCallHandlerRequest(argumentsAsJsonString, ChangeAppGroupIdToolCallHandlerRequest.serializer())
