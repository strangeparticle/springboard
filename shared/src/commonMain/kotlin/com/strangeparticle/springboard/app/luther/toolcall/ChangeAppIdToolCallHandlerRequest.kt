...
@Serializable
internal data class ChangeAppIdToolCallHandlerRequest(
    @ToolFieldDescription("Id of the tab whose springboard to mutate.")
    val tab_id: String,
    @ToolFieldDescription("Current id of the app whose id should change.")
    val id: String,
    @ToolFieldDescription("Replacement id for the existing app.")
    val new_id: String,
