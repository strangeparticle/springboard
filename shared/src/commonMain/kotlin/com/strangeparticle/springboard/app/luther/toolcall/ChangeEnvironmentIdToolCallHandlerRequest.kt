...
@Serializable
internal data class ChangeEnvironmentIdToolCallHandlerRequest(
    @ToolFieldDescription("Id of the tab whose springboard to mutate.")
    val tab_id: String,
    @ToolFieldDescription("Current id of the environment whose id should change.")
    val id: String,
    @ToolFieldDescription("Replacement id for the existing environment.")
    val new_id: String,
