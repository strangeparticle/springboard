...
import com.strangeparticle.springboard.app.domain.mutator.updateAppGroup

internal class UpdateAppGroupToolCallHandler : ToolCallHandler {
    override val providerToolId = "update_app_group"
    override val description = "Update an existing appgroup."
    override val schema = requestSchema(UpdateAppGroupToolCallHandlerRequest.serializer())

    suspend fun executeToolCallHandler(args: UpdateAppGroupToolCallHandlerRequest, context: SpringboardToolCallExecutionContext): SpringboardToolCallHandlerResponse {
        ...
        return context.applyMutation(args.tab_id) { updateAppGroup(springboard, args.id, args.description) }
    }
    ...
    override suspend fun executeToolCallHandler(toolCallId: String, argumentsAsJsonString: String, context: ToolCallExecutionContext): ToolCallHandlerResponse {
        val args = decodeToolCallHandlerRequest(argumentsAsJsonString, UpdateAppGroupToolCallHandlerRequest.serializer())
